...
function goToBattlePage(){
  ...
  localStorage.setItem('gy_battle_role', selectedRole || '');
  window.location.href = `game.html?room=${encodeURIComponent(currentRoomCode)}&slot=${encodeURIComponent(currentSlot)}`;
}
